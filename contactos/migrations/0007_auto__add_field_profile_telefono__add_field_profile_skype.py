...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.telefono'
        db.add_column('contactos_profile', 'telefono',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Profile.skype'
        db.add_column('contactos_profile', 'skype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.telefono'
        db.delete_column('contactos_profile', 'telefono')

        # Deleting field 'Profile.skype'
        db.delete_column('contactos_profile', 'skype')
