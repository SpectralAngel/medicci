...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Venta'
        db.create_table('contactos_venta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cuenta', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ventas', to=orm['contactos.Cuenta'])),
            ('producto', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ventas', to=orm['contactos.Producto'])),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('vendedor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ventas', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('contactos', ['Venta'])

        # Adding field 'Contacto.horario'
        db.add_column('contactos_contacto', 'horario',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('contactos_venta')

        # Deleting field 'Contacto.horario'
        db.delete_column('contactos_contacto', 'horario')
