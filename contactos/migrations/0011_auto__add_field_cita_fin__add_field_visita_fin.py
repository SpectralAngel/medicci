...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cita.fin'
        db.add_column('contactos_cita', 'fin',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Visita.fin'
        db.add_column('contactos_visita', 'fin',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cita.fin'
        db.delete_column('contactos_cita', 'fin')

        # Deleting field 'Visita.fin'
        db.delete_column('contactos_visita', 'fin')
