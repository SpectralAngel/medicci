...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contactos_hospital', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('contactos', ['Hospital'])

        # Deleting field 'Cuenta.tipo'
        db.delete_column('contactos_cuenta', 'tipo')

        # Adding field 'Cuenta.hospital'
        db.add_column('contactos_cuenta', 'hospital',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='cuentas', to=orm['contactos.Hospital']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Hospital'
        db.delete_table('contactos_hospital')

        # Adding field 'Cuenta.tipo'
        db.add_column('contactos_cuenta', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Deleting field 'Cuenta.hospital'
        db.delete_column('contactos_cuenta', 'hospital_id')
