...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contactos_profile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('zona', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='perfiles', null=True, to=orm['contactos.Zona'])),
            ('configurado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('contactos', ['Profile'])

        # Adding model 'Zona'
        db.create_table('contactos_zona', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('contactos', ['Zona'])

        # Adding field 'Hospital.zona'
        db.add_column('contactos_hospital', 'zona',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hospitales', to=orm['contactos.Zona']),
                      keep_default=False)

        # Adding field 'Hospital.numero'
        db.add_column('contactos_hospital', 'numero',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Hospital.direccion'
        db.add_column('contactos_hospital', 'direccion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('contactos_profile')

        # Deleting model 'Zona'
        db.delete_table('contactos_zona')

        # Deleting field 'Hospital.zona'
        db.delete_column('contactos_hospital', 'zona_id')

        # Deleting field 'Hospital.numero'
        db.delete_column('contactos_hospital', 'numero')

        # Deleting field 'Hospital.direccion'
        db.delete_column('contactos_hospital', 'direccion')
