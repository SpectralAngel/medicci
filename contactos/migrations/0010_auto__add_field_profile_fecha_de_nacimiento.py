...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.fecha_de_nacimiento'
        db.add_column('contactos_profile', 'fecha_de_nacimiento',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.fecha_de_nacimiento'
        db.delete_column('contactos_profile', 'fecha_de_nacimiento')
