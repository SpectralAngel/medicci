...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BBPin'
        db.create_table('contactos_bbpin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contacto', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bbpins', to=orm['contactos.Contacto'])),
            ('numero', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('contactos', ['BBPin'])


    def backwards(self, orm):
        # Deleting model 'BBPin'
        db.delete_table('contactos_bbpin')
