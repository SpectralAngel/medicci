...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hospital.municipio'
        db.add_column('contactos_hospital', 'municipio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hospitales', to=orm['contactos.Municipio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hospital.municipio'
        db.delete_column('contactos_hospital', 'municipio_id')
