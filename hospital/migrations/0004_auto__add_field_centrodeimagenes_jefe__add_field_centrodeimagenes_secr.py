...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CentroDeImagenes.jefe'
        db.add_column('hospital_centrodeimagenes', 'jefe',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='jefe_imagenes', null=True, to=orm['contactos.Contacto']),
                      keep_default=False)

        # Adding field 'CentroDeImagenes.secretaria'
        db.add_column('hospital_centrodeimagenes', 'secretaria',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secretaria_imagenes', null=True, to=orm['contactos.Contacto']),
                      keep_default=False)

        # Adding M2M table for field tecnicos on 'CentroDeImagenes'
        db.create_table('hospital_centrodeimagenes_tecnicos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('centrodeimagenes', models.ForeignKey(orm['hospital.centrodeimagenes'], null=False)),
            ('contacto', models.ForeignKey(orm['contactos.contacto'], null=False))
        ))
        db.create_unique('hospital_centrodeimagenes_tecnicos', ['centrodeimagenes_id', 'contacto_id'])

        # Adding M2M table for field radiologos on 'CentroDeImagenes'
        db.create_table('hospital_centrodeimagenes_radiologos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('centrodeimagenes', models.ForeignKey(orm['hospital.centrodeimagenes'], null=False)),
            ('contacto', models.ForeignKey(orm['contactos.contacto'], null=False))
        ))
        db.create_unique('hospital_centrodeimagenes_radiologos', ['centrodeimagenes_id', 'contacto_id'])


    def backwards(self, orm):
        # Deleting field 'CentroDeImagenes.jefe'
        db.delete_column('hospital_centrodeimagenes', 'jefe_id')

        # Deleting field 'CentroDeImagenes.secretaria'
        db.delete_column('hospital_centrodeimagenes', 'secretaria_id')

        # Removing M2M table for field tecnicos on 'CentroDeImagenes'
        db.delete_table('hospital_centrodeimagenes_tecnicos')

        # Removing M2M table for field radiologos on 'CentroDeImagenes'
        db.delete_table('hospital_centrodeimagenes_radiologos')
