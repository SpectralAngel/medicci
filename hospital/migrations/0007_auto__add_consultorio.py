...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hospital_consultorio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hospital', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consultorios', to=orm['contactos.Hospital'])),
            ('medico', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='consultorios', null=True, to=orm['contactos.Contacto'])),
            ('secretaria', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secretaria_consultorio', null=True, to=orm['contactos.Contacto'])),
        ))
        db.send_create_signal('hospital', ['Consultorio'])


    def backwards(self, orm):
        # Deleting model 'Consultorio'
        db.delete_table('hospital_consultorio')
    ...
    models = {
        ...
        'hospital.consultorio': {
            ...
            'hospital': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'consultorios'", 'to': "orm['contactos.Hospital']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medico': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'consultorios'", 'null': 'True', 'to': "orm['contactos.Contacto']"}),
            'secretaria': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'secretaria_consultorio'", 'null': 'True', 'to': "orm['contactos.Contacto']"})
        },
