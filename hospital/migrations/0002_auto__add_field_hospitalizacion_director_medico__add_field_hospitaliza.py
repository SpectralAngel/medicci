...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hospitalizacion.director_medico'
        db.add_column('hospital_hospitalizacion', 'director_medico',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='director_medico', null=True, to=orm['contactos.Contacto']),
                      keep_default=False)

        # Adding field 'Hospitalizacion.hospitalizador'
        db.add_column('hospital_hospitalizacion', 'hospitalizador',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hospitalizador', null=True, to=orm['contactos.Contacto']),
                      keep_default=False)

        # Adding field 'Hospitalizacion.cuantas_habitaciones_suite_posee'
        db.add_column('hospital_hospitalizacion', 'cuantas_habitaciones_suite_posee',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hospitalizacion.director_medico'
        db.delete_column('hospital_hospitalizacion', 'director_medico_id')

        # Deleting field 'Hospitalizacion.hospitalizador'
        db.delete_column('hospital_hospitalizacion', 'hospitalizador_id')

        # Deleting field 'Hospitalizacion.cuantas_habitaciones_suite_posee'
        db.delete_column('hospital_hospitalizacion', 'cuantas_habitaciones_suite_posee')
