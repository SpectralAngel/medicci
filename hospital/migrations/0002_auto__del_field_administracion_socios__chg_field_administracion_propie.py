...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Administracion.socios'
        db.delete_column('hospital_administracion', 'socios')
        ...
        # Renaming column for 'Administracion.propietario' to match new field type.
        db.rename_column('hospital_administracion', 'propietario', 'propietario_id')
        # Changing field 'Administracion.propietario'
        db.alter_column('hospital_administracion', 'propietario_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'Administracion', fields ['propietario']
        db.create_index('hospital_administracion', ['propietario_id'])


        # Renaming column for 'Administracion.administrador' to match new field type.
        db.rename_column('hospital_administracion', 'administrador', 'administrador_id')
        # Changing field 'Administracion.administrador'
        db.alter_column('hospital_administracion', 'administrador_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'Administracion', fields ['administrador']
        db.create_index('hospital_administracion', ['administrador_id'])


        # Renaming column for 'Administracion.jefe_de_compras' to match new field type.
        db.rename_column('hospital_administracion', 'jefe_de_compras', 'jefe_de_compras_id')
        # Changing field 'Administracion.jefe_de_compras'
        db.alter_column('hospital_administracion', 'jefe_de_compras_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'Administracion', fields ['jefe_de_compras']
        db.create_index('hospital_administracion', ['jefe_de_compras_id'])

        # Deleting field 'Quirofano.doctores'
        db.delete_column('hospital_quirofano', 'doctores')
        ...
        # Renaming column for 'Quirofano.instrumentista' to match new field type.
        db.rename_column('hospital_quirofano', 'instrumentista', 'instrumentista_id')
        # Changing field 'Quirofano.instrumentista'
        db.alter_column('hospital_quirofano', 'instrumentista_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'Quirofano', fields ['instrumentista']
        db.create_index('hospital_quirofano', ['instrumentista_id'])


        # Renaming column for 'Quirofano.jefe' to match new field type.
        db.rename_column('hospital_quirofano', 'jefe', 'jefe_id')
        # Changing field 'Quirofano.jefe'
        db.alter_column('hospital_quirofano', 'jefe_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'Quirofano', fields ['jefe']
        db.create_index('hospital_quirofano', ['jefe_id'])


        # Renaming column for 'Quirofano.secretaria' to match new field type.
        db.rename_column('hospital_quirofano', 'secretaria', 'secretaria_id')
        # Changing field 'Quirofano.secretaria'
        db.alter_column('hospital_quirofano', 'secretaria_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'Quirofano', fields ['secretaria']
        db.create_index('hospital_quirofano', ['secretaria_id'])

        # Deleting field 'CentroTecnico.tecnicos'
        db.delete_column('hospital_centrotecnico', 'tecnicos')

        # Deleting field 'CentroTecnico.radiologos'
        db.delete_column('hospital_centrotecnico', 'radiologos')
        ...
        # Renaming column for 'CentroTecnico.secretaria' to match new field type.
        db.rename_column('hospital_centrotecnico', 'secretaria', 'secretaria_id')
        # Changing field 'CentroTecnico.secretaria'
        db.alter_column('hospital_centrotecnico', 'secretaria_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contactos.Contacto']))
        # Adding index on 'CentroTecnico', fields ['secretaria']
        db.create_index('hospital_centrotecnico', ['secretaria_id'])


        # Renaming column for 'CentroTecnico.jefe' to match new field type.
        db.rename_column('hospital_centrotecnico', 'jefe', 'jefe_id')
        # Changing field 'CentroTecnico.jefe'
        db.alter_column('hospital_centrotecnico', 'jefe_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contactos.Contacto'], null=True))
        # Adding index on 'CentroTecnico', fields ['jefe']
        db.create_index('hospital_centrotecnico', ['jefe_id'])


    def backwards(self, orm):
        # Removing index on 'CentroTecnico', fields ['jefe']
        db.delete_index('hospital_centrotecnico', ['jefe_id'])

        # Removing index on 'CentroTecnico', fields ['secretaria']
        db.delete_index('hospital_centrotecnico', ['secretaria_id'])

        # Removing index on 'Quirofano', fields ['secretaria']
        db.delete_index('hospital_quirofano', ['secretaria_id'])

        # Removing index on 'Quirofano', fields ['jefe']
        db.delete_index('hospital_quirofano', ['jefe_id'])

        # Removing index on 'Quirofano', fields ['instrumentista']
        db.delete_index('hospital_quirofano', ['instrumentista_id'])

        # Removing index on 'Administracion', fields ['jefe_de_compras']
        db.delete_index('hospital_administracion', ['jefe_de_compras_id'])

        # Removing index on 'Administracion', fields ['administrador']
        db.delete_index('hospital_administracion', ['administrador_id'])

        # Removing index on 'Administracion', fields ['propietario']
        db.delete_index('hospital_administracion', ['propietario_id'])

        # Adding field 'Administracion.socios'
        db.add_column('hospital_administracion', 'socios',
        ...
        # Renaming column for 'Administracion.propietario' to match new field type.
        db.rename_column('hospital_administracion', 'propietario_id', 'propietario')
        # Changing field 'Administracion.propietario'
        db.alter_column('hospital_administracion', 'propietario', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Renaming column for 'Administracion.administrador' to match new field type.
        db.rename_column('hospital_administracion', 'administrador_id', 'administrador')
        # Changing field 'Administracion.administrador'
        db.alter_column('hospital_administracion', 'administrador', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Renaming column for 'Administracion.jefe_de_compras' to match new field type.
        db.rename_column('hospital_administracion', 'jefe_de_compras_id', 'jefe_de_compras')
        # Changing field 'Administracion.jefe_de_compras'
        db.alter_column('hospital_administracion', 'jefe_de_compras', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
        # Adding field 'Quirofano.doctores'
        db.add_column('hospital_quirofano', 'doctores',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        ...
        # Renaming column for 'Quirofano.instrumentista' to match new field type.
        db.rename_column('hospital_quirofano', 'instrumentista_id', 'instrumentista')
        # Changing field 'Quirofano.instrumentista'
        db.alter_column('hospital_quirofano', 'instrumentista', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Renaming column for 'Quirofano.jefe' to match new field type.
        db.rename_column('hospital_quirofano', 'jefe_id', 'jefe')
        # Changing field 'Quirofano.jefe'
        db.alter_column('hospital_quirofano', 'jefe', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Renaming column for 'Quirofano.secretaria' to match new field type.
        db.rename_column('hospital_quirofano', 'secretaria_id', 'secretaria')
        # Changing field 'Quirofano.secretaria'
        db.alter_column('hospital_quirofano', 'secretaria', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
        # Adding field 'CentroTecnico.tecnicos'
        db.add_column('hospital_centrotecnico', 'tecnicos',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CentroTecnico.radiologos'
        db.add_column('hospital_centrotecnico', 'radiologos',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        ...
        # Renaming column for 'CentroTecnico.secretaria' to match new field type.
        db.rename_column('hospital_centrotecnico', 'secretaria_id', 'secretaria')
        # Changing field 'CentroTecnico.secretaria'
        db.alter_column('hospital_centrotecnico', 'secretaria', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Renaming column for 'CentroTecnico.jefe' to match new field type.
        db.rename_column('hospital_centrotecnico', 'jefe_id', 'jefe')
        # Changing field 'CentroTecnico.jefe'
        db.alter_column('hospital_centrotecnico', 'jefe', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
